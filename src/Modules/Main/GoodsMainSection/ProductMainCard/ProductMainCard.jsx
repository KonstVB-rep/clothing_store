...
const ProductMainCard = ({ product }) => {
  ...
  return (
    <Card className="m-auto w-full h-full aspect-[1/2] max-w-[800px] relative shadow-lg shadow-black bg-gray-900 rounded-3xl overflow-hidden">
      <Typography
        variant="h4"
      ...
      <CardFooter className="flex justify-center gap-7 pt-2">
        <AddToCartButton
          product={{ ...product, size: defaultSize, color: defaultColor }}
        />
      </CardFooter>
    </Card>
  );
