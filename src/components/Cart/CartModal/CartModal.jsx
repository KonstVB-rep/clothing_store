  ...
  return (
    <div className="fixed inset-0 overflow-y-auto bg-black/50">
      <div className="flex min-h-full items-center justify-center p-4 text-center">
        ...
        >
          <Dialog.Panel className=" w-full max-h-[85vh] relative max-w-[1000px] transform overflow-hidden rounded-2xl bg-white pt-10 text-left align-middle shadow-xl transition-all">
            <button
